...
import com.refactorlabs.cs378.assign5.Event;
import com.refactorlabs.cs378.assign5.EventType;
import com.refactorlabs.cs378.assign5.EventSubtype;
import com.refactorlabs.cs378.assign5.BodyStyle;
import com.refactorlabs.cs378.assign5.CabStyle;
import com.refactorlabs.cs378.assign5.VehicleCondition;
import com.refactorlabs.cs378.assign5.UserSessionData;
...
public class UserSession extends Configured implements Tool {
    ...
    public static class MapperClass extends Mapper<LongWritable, Text, Text, AvroValue<UserSessionData>> {
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            UserSessionData.Builder builder = UserSessionData.newBuilder();
    ...
    public static void bodystyleenums(String token, Event event){
        ...
        if(token.equals("Chassis")){
            BodyStyle b = BodyStyle.valueOf("CHASSIS");
            event.setBodyStyle(b);
        }        
    }
    ...
    public static void vehicleenums(String token, Event event){
       ...
       if(token.equals("CPO")){
           VehicleCondition v = VehicleCondition.valueOf("CPO");
           event.setVehicleCondition(v);
       }   	
    }
     ...
     */
    public static class ReduceClass extends Reducer<Text, AvroValue<UserSessionData>, AvroKey<CharSequence>,
            AvroValue<UserSessionData>> {

        @Override
        public void reduce(Text key, Iterable<AvroValue<UserSessionData>> values, Context context)
                throws IOException, InterruptedException {
            ...
            for (AvroValue<UserSessionData> value : values) {
                UserSessionData session = value.datum();
    ...
    public int run(String[] args) throws Exception {
        ...
        AvroJob.setMapOutputValueSchema(job, UserSessionData.getClassSchema());

        // Specify the Reduce
        job.setOutputFormatClass(TextOutputFormat.class);
        job.setReducerClass(ReduceClass.class);
        AvroJob.setOutputKeySchema(job, Schema.create(Schema.Type.STRING));
        AvroJob.setOutputValueSchema(job, UserSessionData.getClassSchema());
